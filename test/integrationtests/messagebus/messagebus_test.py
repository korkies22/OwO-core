...
It's important to note that this requires this test to run OwO service
...
class TestMessagebusMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        This requires starting the OwO service and creating two
        WebsocketClient object to talk with eachother.  Not this is
        threaded and will require cleanup
        """
        # start the OwO service. and get the pid of the script.
        self.pid = Popen(["python", "OwO/messagebus/service/main.py"]).pid
    ...
    def tearDown(self):
        ...
        OwO service that was started in setUp.
        """
        self.ws1.close()
        self.ws2.close()
