...
class MockRecognizer(object):
    ...
    def recognize_OwO(self, audio, key=None,
...
class AudioConsumerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.consumer = AudioConsumer(
            self.loop.state, self.queue, self.loop, OwOSTT(),
    ...
    def test_word_extraction(self):
        """
        This is intended to test the extraction of the word: ``OwO``.
        ...
        audio = self.__create_sample_from_test_file('weather_OwO')
    ...
    def test_wakeword_in_beginning(self):
        self.queue.put(self.__create_sample_from_test_file('weather_OwO'))
        self.recognizer.set_transcriptions(["what's the weather next week"])
        monitor = {}
    ...
    def test_wakeword(self):
        self.queue.put(self.__create_sample_from_test_file('OwO'))
    ...
    def test_wakeup(self):
        self.queue.put(self.__create_sample_from_test_file('OwO_wakeup'))
        self.loop.sleep()
        self.consumer.read()
