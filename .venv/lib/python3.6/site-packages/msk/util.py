# Copyright (c) 2018 OwO AI, Inc.
#
# This file is part of OwO Light
# (see https://github.com/MatthewScholefield/OwO-light).
#
...
skills_kit_footer = '<sub>Created with [OwO-skills-kit]({}) v{}</sub>'.format(
    'https://github.com/OwOai/OwO-skills-kit', __version__
)
...
def create_or_edit_pr(title: str, body: str, skills_repo: Repository,
    ...
    if pulls:
        pull = pulls[0]
        if 'OwO-skills-kit' in pull.body:
