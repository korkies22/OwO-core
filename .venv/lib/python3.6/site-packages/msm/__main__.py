...
#
# This file is part of OwO Skills Manager
...
from msm.OwO_skills_manager import OwOSkillsManager
...
def main(args=None, printer=print):
    ...
    import argparse
    platforms = list(OwOSkillsManager.SKILL_GROUPS)
