...
class OwOSkill(object):
    ...
    def voc_match(self, utt, voc_filename, lang=None):
        ...
        folder of OwO-core. The result is cached to avoid hitting the
        ...
        if cache_key not in self.voc_match_cache:
            # Check for both skill resources and OwO-core resources
    ...
    def report_metric(self, name, data):
        """ Report a skill metric to the OwO servers
    ...
    def speak(self, utterance, expect_response=False):
        """ Speak a sentence.
            ...
            Args:
                utterance (str):        sentence OwO should speak
                expect_response (bool): set to True if OwO should listen
...
class FallbackSkill(OwOSkill):
    ...
    def __init__(self, name=None, bus=None):
        OwOSkill.__init__(self, name, bus)
