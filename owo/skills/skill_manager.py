...
class SkillManager(Thread):
    ...
    Arguments:
        bus (eventemitter): OwO messagebus connection
    """
    ...
    def load_skills_data() -> dict:
        ...
        skills_data_file = expanduser('~/.OwO/skills.json')
    ...
    def installed_skills_file(self):
        ...
        if os.access(venv, os.W_OK | os.R_OK | os.X_OK):
            return join(venv, '.OwO-skills')
        return expanduser('~/.OwO/.OwO-skills')
