...
def is_paired(ignore_errors=True):
    ...
    Determines if the installation of OwO has been paired by the user
    ...
    try:
        ...
        LOG.warning('no se puede obtener información del dispositivo: ' + repr(e))
    if ignore_errors:
        return False
    if connected():
        raise BackendDown
