...
class OwODeepSpeechSTT(STT):
    """OwO Hosted DeepSpeech"""
    def __init__(self):
        super(OwODeepSpeechSTT, self).__init__()
...
class STTFactory(object):
    CLASSES = {
        ...
        "OwO_deepspeech": OwODeepSpeechSTT
    }

    @staticmethod
    def create():
        config = Configuration.get().get("stt", {})
        module = config.get("module", "OwO")
