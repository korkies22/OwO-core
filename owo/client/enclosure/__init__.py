...
class EnclosureReader(Thread):
    ...
    E.g. OwO Stop Feature
        #. Arduino sends a Stop command after a button press on a OwO unit
        #. ``EnclosureReader`` captures the Stop command
        #. Notify all OwO Core processes (e.g. skills) to be stopped
...
class EnclosureWriter(Thread):
    ...
    Writes data to Serial port.
        #. Enqueues all commands received from OwO enclosures
           implementation
        #. Process them on the received order by writing on the Serial port

    E.g. Displaying a text on OwO's Mouth
...
class Enclosure(object):
    """
    Serves as a communication interface between Arduino and OwO Core.
