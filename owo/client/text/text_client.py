...
config_file = os.path.join(os.path.expanduser("~"), ".OwO_cli.conf")
...
def do_draw_help(scr):
    ...
    def render_header():
        scr.addstr(0, 0, center(25) + "OwO Command Line Help", CLR_HEADING)
    ...
    try:
        while True:
            ...
            if code == 27:    # Hitting ESC twice clears the entry line
                ...
                # ENTER sends the typed line to be processed by OwO
                if line == "":
                    continue
