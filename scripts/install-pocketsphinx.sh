...
function enable_local() {
    sed -i 's/from pocketsphinx.pocketsphinx import Decoder/from pocketsphinx import Decoder/g' OwO/client/speech/local_recognizer.py
}

function disable_local() {
    sed -i 's/from pocketsphinx import Decoder/from pocketsphinx.pocketsphinx import Decoder/g' OwO/client/speech/local_recognizer.py
}
